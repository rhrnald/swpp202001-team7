...
define void @copy_mask(i32 %dim, i32 %row, i32 %col, i64* %mat, i64* %mask) #0 {
entry:
  br label %for.cond
...
; Function Attrs: nounwind ssp uwtable
define void @add_mask(i32 %dim, i32 %row, i32 %col, i64* %mat, i64* %mask) #0 {
entry:
  br label %for.cond
...
; Function Attrs: nounwind ssp uwtable
define void @mask_mul(i64* %c, i64* %a, i64* %b) #0 {
entry:
  br label %for.cond
